...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/logoi.png">
    <title>HRM-360</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div class="login-box card" style="background-color: rgba(255, 255, 255, 0.9); border-radius: 20px; height:450px; padding: 20px; justify-content:center;">
            <div class="card-body loginpage">
                ...
                <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/logoi.png" style="height: 140px; padding: 10px;" alt="Home" /></a>
                <div class="form-group" style="margin-top: 0;">
                 ...
                 <div class="form-check">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-login btn-block text-uppercase waves-effect waves-light"  type="submit">Log In</button>                        </div>
                    </div>
                </form>
            </div>
        </div>
